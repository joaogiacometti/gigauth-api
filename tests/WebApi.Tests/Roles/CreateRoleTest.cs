...
public class CreateRoleTest: GigAuthFixture
{
    private const string Method = "role/create";
    private readonly string _adminToken;
    private readonly string _userToken;
    
    public CreateRoleTest(CustomWebApplicationFactory webApplicationFactory) : base(webApplicationFactory)
    {
